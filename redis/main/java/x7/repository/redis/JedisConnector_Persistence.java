...
public class JedisConnector_Persistence {
	...
	public static JedisConnector_Persistence getInstance() {
		if (instance == null) {
			...
			config.setMaxTotal(Configs.getIntValue("REDIS_MAX_PERSISTENCE"));
			config.setMaxIdle(Configs.getIntValue("REDIS_IDLE_PERSISTENCE"));
			...
			pool = new JedisPool(config, Configs.getString("REDIS_IP_PERSISTENCE"),
					Configs.getIntValue("REDIS_PORT_PERSISTENCE")); // 6379
		}
		return instance;
	}
