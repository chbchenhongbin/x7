...
import x7.repository.mapper.BeanSqlMapper_Migration;
 ...
 * @param <T>
 */
public class MigrationDaoImpl {

	private static MigrationDaoImpl instance;

	public static MigrationDaoImpl getInstance() {
		if (instance == null) {
			instance = new MigrationDaoImpl();
		}
		return instance;
	}

	private MigrationDaoImpl() {
	}
	...
	public int create(Object obj) {
		...
		String sql = BeanSqlMapper_Migration.getSql(clz, Mapper.CREATE);
	...
	public <T> List<T> list(Class<T> clz, int id) {
		...
		String sql = BeanSqlMapper_Migration.getSql(clz, Mapper.QUERY);
		List<BeanElement> eles = BeanSqlMapper_Migration.getElementList(clz);
	...
	public <T> T get(Class<T> clz, int idOne, int idTwo) {
		...
		String sql = BeanSqlMapper_Migration.getSql(clz, Mapper.QUERY_TWO);
		List<BeanElement> eles = BeanSqlMapper_Migration.getElementList(clz);
	...
	public <T> List<T> list(Class<T> clz) {
		...
		String sql = BeanSqlMapper_Migration.getSql(clz, Mapper.LOAD);
		List<BeanElement> eles = BeanSqlMapper_Migration.getElementList(clz);
	...
	private void filterTryToCreate(Class clz) {
		...
		try {
			...
			String index = BeanSqlMapper_Migration.getSql(clz, Mapper.INDEX);
			if (index != null){
